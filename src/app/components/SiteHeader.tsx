...
import { TASK_TYPES } from '../lib/quests-data';
      ...
      <header>
        ...
        <nav>
          <ul>
            ...
            <li className="nav-browse-mobile"><Link href="/quests"><span className="nav-rn">Browse</span></Link></li>
            ...
            <li className="nav-mega-li" ref={megaRef}>
              ...
              >
                ...
                <span className="material-symbols-outlined nav-mega-trigger__chev" aria-hidden="true">keyboard_arrow_down</span>
              </button>
              ...
              <div id="browse-dropdown" className="nav-mega" hidden={!menuOpen}>
                <div className="nav-mega__inner">
                  ...
                  <div className="nav-mega__intent">
                    <p className="nav-mega__intent-title">What are you looking for?</p>
                    <p className="nav-mega__intent-sub">Pick a type of task.</p>
                    <div className="nav-mega__tabs" role="tablist" aria-label="Browse intent">
                      <button
                        type="button"
                        role="tab"
                        id="browse-tab-hero"
                        ...
                        className={`nav-mega__tab${intent === 'hero' ? ' is-active' : ''}`}
                        onClick={() => setIntent('hero')}
                        onMouseEnter={() => setIntent('hero')}
                      >
                        <span className="nav-mega__tab-eyebrow">As a Hero</span>
                        <span className="nav-mega__tab-desc">I’m looking for work</span>
                      </button>
                      <button
                        type="button"
                        role="tab"
                        ...
                        aria-controls="browse-tabpanel"
                        className={`nav-mega__tab${intent === 'poster' ? ' is-active' : ''}`}
                        onClick={() => setIntent('poster')}
                        onMouseEnter={() => setIntent('poster')}
                      >
                        <span className="nav-mega__tab-eyebrow">As a poster</span>
                        <span className="nav-mega__tab-desc">I’m looking to hire someone</span>
                      </button>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    role="tabpanel"
                    id="browse-tabpanel"
                    aria-labelledby={intent === 'hero' ? 'browse-tab-hero' : 'browse-tab-poster'}
                  >
                    <ul className="nav-mega__grid">
                      {TASK_TYPES.map((t) => (
                        <li key={t.label}>
                          <Link
                            href={`/quests/${t.category}${intent === 'poster' ? '' : t.sub ? `?sub=${t.sub}` : ''}`}
                      ...
                      <li>
                        <Link href="/quests" className="nav-mega__link nav-mega__link--all" onClick={() => setMenuOpen(false)}>
                          View all
                        </Link>
                      </li>
                    </ul>
        ...
        <div className="nav-actions">
          <a href="/login" className="nav-login"><span className="nav-rn">Log in</span></a>
          <button className="primary"><span>Hire a human</span></button>
        </div>
      </header>
    </div>
  );
