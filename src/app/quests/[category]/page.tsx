...
import { QUEST_CATEGORIES, getCategory, monthlyEstimate } from '../../lib/quests-data';
import { HERO_REASONS, HOW_STEPS, TOP_HEROES, HERO_FAQS, EARN_CURVE } from '../../lib/hero-page-data';
...
export default async function CategoryPage({ params }: { params: Params }) {
  ...
  // step illustrations are keyed off the step index
  ...
  return (
    <>
      ...
      {/* ── Category FAQ (reuses the landing .faq-* styles) ── */}
      ...
      {/* ── Closing CTA + footer (reused from the landing) ── */}
      <CtaSection />
      <SiteFooter />
      <ScrollFX />
    </>
